...
<meta name="description" content="OpenBiblio Library Automation System">
                                 <title><?php echo $loc->getText("helpHeaderTitle");
?></title>
...
<td class="title" valign="top" nowrap="yes"><font class="small"><a href="javascript:window.close()"><font color="<?php echo H(OBIB_TITLE_FONT_COLOR)?>"><?php echo $loc->getText("helpHeaderCloseWin");
?></font></a>&nbsp;
&nbsp;
</font></td>
</tr>
...
<table class="primary" width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            ?>
            &raquo;
            <?php echo $loc->getText("helpHeaderContents");
            ?>
            <?php
        } else {
            ?>
            <a href="../shared/help.php" class="alt1"><?php echo $loc->getText("helpHeaderContents");
            ?></a>
            <?php
        } ?>
<br>
<a href="javascript:self.print();" class="alt1"><?php echo $loc->getText("helpHeaderPrint");
?></a><br>
</font>
</td>
<td bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
