...
?>
<br>
<h1>GOpenBiblio Installation:</h1>
...
if ($version) {
    if (!isset($_POST["confirm"]) or ($_POST["confirm"] != "yes")) {
        ...
        <form method="POST" action="../install/install.php">
                                   GOpenBiblio (version <?php echo H($version); ?>) is already installed.
                                   Are you sure you want to delete all library data and create new GOpenBiblio
                                   tables?<br>
