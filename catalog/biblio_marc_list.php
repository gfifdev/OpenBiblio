...
****************************************************************************
-->
<h1><?php echo $loc->getText("biblioMarcListHdr");
?>:</h1>
...
if ($fieldQ->getRowCount() == 0) {
    ...
    while ($fld = $fieldQ->fetchField()) {
        ...
        <td valign="top" class="<?php echo H($row_class);?>">
                                       <a href="../catalog/biblio_marc_edit_form.php?bibid=<?php echo HURL($bibid);?>&amp;fieldid=<?php echo HURL($fld->getFieldid());?>&amp;reset=Y"><?php echo $loc->getText("biblioMarcListEdit");
        ?></a>
        </td>
    <td valign="top" class="<?php echo H($row_class);?>">
                                       <a href="../catalog/biblio_marc_del_confirm.php?bibid=<?php echo HURL($bibid);?>&amp;fieldid=<?php echo H($fld->getFieldid());?>&amp;tag=<?php echo HURL($tag);?>&amp;subfieldCd=<?php echo HURL($fld->getSubfieldCd());?>"><?php echo $loc->getText("biblioMarcListDel");
        ?></a>
        </td>
    <td valign="top" class="<?php echo H($row_class);?>">
                                       <?php echo H($tag);
