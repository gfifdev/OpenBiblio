...
<meta name="description" content="OpenBiblio Library Automation System">
                                 <title><?php echo $loc->getText("usmarcSelectHdr");
?></title>
...
<td class="title" valign="top" nowrap="yes"><font class="small"><a href="javascript:window.close()"><font color="<?php echo H(OBIB_TITLE_FONT_COLOR)?>"><?php echo $loc->getText("usmarcCloseWindow");
?></font></a>&nbsp;
&nbsp;
</font></td>
</tr>
                                         ...
                                         <td><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                                                 ...
                                                 <font class="primary">
                                                             ...
                                                             **************************************************************************************-->
                                                                 ...
                                                                 <h1><?php echo $loc->getText("usmarcSelectInst");
?>:</h1>
                            ...
                            <tr><td class="noborder" colspan="2"></td>
                                                                 <td class="noborder">
                                                                             <a href="javascript:backToMain('<?php echo H(addslashes($retPage.$sepchar."tag=".U($selectedTag)."&subfld=".U($subfld->getSubfieldCd())."&descr=".U($subfld->getDescription()))) ?>')" class="nav">
                                                                                             <?php echo $loc->getText("usmarcSelectUse");
                            ?></a>
                        </td><td class="noborder" width="100%">
                                                                    <?php echo H($subfld->getSubfieldCd()." - ".$subfld->getDescription());
                            ?></a><br>
                            </td></tr>
                            <?php
                        }
