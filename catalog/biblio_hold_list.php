...
?>
<h1><?php echo $loc->getText("biblioHoldListHead");
?></h1>
<?php echo $msg ?>
<table class="primary">
                 <tr>
...
if ($holdQ->getRowCount() == 0) {
    ...
    while ($hold = $holdQ->fetchRow()) {
        ...
        <td class="primary" valign="top" nowrap="yes">
                                                        <a href="../shared/hold_del_confirm.php?bibid=<?php echo HURL($hold->getBibid());?>&amp;copyid=<?php echo HURL($hold->getCopyid());?>&amp;holdid=<?php echo HURL($hold->getHoldid());?>"><?php echo $loc->getText("biblioHoldListdel");
        ?></a>
        </td>
