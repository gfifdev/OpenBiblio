...
<h1><?php echo $loc->getText("mbrAccountHead1");
?></h1>
<table class="primary">
                 <tr>
...
if ($transQ->getRowCount() == 0) {
    ...
    $bal = 0;
    ?>
    <tr><td class="primary" colspan="5"><?php echo $loc->getText("mbrAccountOpenBal");
    ?></td><td class="primary"><?php echo H(moneyFormat($bal,2));
    ?></td></tr>
    ...
    while ($trans = $transQ->fetchRow()) {
        ...
        <td class="primary" valign="top" >
                                           <a href="../circ/mbr_transaction_del_confirm.php?mbrid=<?php echo HURL($mbrid);?>&amp;transid=<?php echo HURL($trans->getTransid());?>"><?php echo $loc->getText("mbrAccountDel");
        ?></a>
        </td>
    <td class="primary" valign="top" >
