...
$searchText = mb_eregi_replace("[[:space:]]+", " ", $searchText);
...
<td nowrap="true" class="primary">
                                    <a href="../circ/mbr_view.php?mbrid=<?php echo HURL($mbr->getMbrid());?>&amp;reset=Y"><?php echo H($mbr->getLastName());
    ...
    ?>
    <b><?php echo $loc->getText("mbrsearchCardNumber");
    ?></b> <?php echo H($mbr->getBarcodeNmbr());
    ?>
    <b><?php echo $loc->getText("mbrsearchClassification");
    ?></b> <?php echo H($mbrClassifyDm[$mbr->getClassification()]);
    ?>
    </td>
    </tr>
