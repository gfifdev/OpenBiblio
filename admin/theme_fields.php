...
<table class="primary">
                 ...
                 <th colspan="5" valign="top" nowrap="yes" align="left">
                                            <?php echo $loc->getText("adminTheme_HeaderWording");
?><?php echo $loc->getText("adminTheme_Theme2");
?>
</td>
</tr>
<tr>
...
<td colspan="4" valign="top" class="primary">
                                           <?php printInputText("borderWidth",2,2,$postVars,$pageErrors);
?>px
</td>
</tr>
<tr>
...
<td colspan="4" valign="top" class="primary">
                                           <?php printInputText("tablePadding",2,2,$postVars,$pageErrors);
?>px
</td>
</tr>
...
<td valign="top" class="primary">
                               <?php printInputText("titleFontSize",2,2,$postVars,$pageErrors);
?>px
...
<td valign="top" class="primary">
                               <?php printInputText("primaryFontSize",2,2,$postVars,$pageErrors);
?>px
</td>
<td valign="top" class="primary">
                               <?php printInputText("alt1FontSize",2,2,$postVars,$pageErrors);
?>px
</td>
<td valign="top" class="primary">
                               <?php printInputText("alt2FontSize",2,2,$postVars,$pageErrors);
?>px
