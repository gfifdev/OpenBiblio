...
?>
<a href="../admin/staff_new_form.php?reset=Y"><?php echo $loc->getText("adminStaff_list_formHeader");
?></a><br><br>
<h1><?php echo $loc->getText("adminStaff_list_Columnheader");
?></h1>
<table class="primary">
                 <tr>
...
while ($staff = $staffQ->fetchStaff()) {
    ...
    <td valign="top" class="<?php echo H($row_class);?>">
                                   <a href="../admin/staff_edit_form.php?UID=<?php echo HURL($staff->getUserid());?>" class="<?php echo H($row_class);?>"><?php echo $loc->getText("adminStaff_list_Edit");
    ?></a>
    </td>
<td valign="top" class="<?php echo H($row_class);?>">
                                   <a href="../admin/staff_pwd_reset_form.php?UID=<?php echo HURL($staff->getUserid());?>" class="<?php echo H($row_class);?>"><?php echo $loc->getText("adminStaff_list_Pwd");
    ?></a>
    </td>
<td valign="top" class="<?php echo H($row_class);?>">
                                   <a href="../admin/staff_del_confirm.php?UID=<?php echo HURL($staff->getUserid());?>&amp;LAST=<?php echo HURL($staff->getLastName());?>&amp;FIRST=<?php echo HURL($staff->getFirstName());?>" class="<?php echo H($row_class);?>"><?php echo $loc->getText("adminStaff_list_Del");
    ?></a>
    </td>
<td valign="top" class="<?php echo H($row_class);?>">
