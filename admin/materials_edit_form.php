...
<td align="center" colspan="2" class="primary">
                                         <input type="submit" value="  <?php echo $loc->getText("adminSubmit"); ?>  " class="button">
                                                     <input type="button" onClick="self.location='../admin/materials_list.php'" value="  <?php echo $loc->getText("adminCancel"); ?>  " class="button">
                                                                     ...
                                                                     <table class="primary"><tr><td valign="top" class="noborder"><font class="small"><?php echo $loc->getText("admin_materials_delNote");
?></font></td>
<td class="noborder"><font class="small"><?php echo $loc->getText("admin_materials_delNoteText");
?><br></font>
</td></tr></table>
