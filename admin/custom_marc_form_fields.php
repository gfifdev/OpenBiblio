...
<td  align="right" class="primary">Required?</td>
                             <td  align="Left" class="primary">
                                            <SELECT name="required" id="required" tabindex="4">
                                                        <OPTION value="Y" <?php if ((isset($postVars["required"]))&& ($postVars["required"]=="Y")) echo "selected";
?>>TRUE</OPTION>
 <OPTION value="N" <?php if ((isset($postVars["required"]))&& ($postVars["required"]=="N")) echo "selected";
?>>FALSE</OPTION>
 </SELECT>
 </td></tr>
 ...
 <td  align="right" class="primary">cntrltype</td>
                              <td  align="Left" class="primary">
                                             <SELECT name="cntrltype" id="cntrltype" tabindex="7">
                                                         <OPTION value="0"  <?php if((isset($postVars["cntrltype"]))&&($postVars["cntrltype"]=="0")) echo "selected";
?>>Text Field</OPTION>
 <OPTION value="1"  <?php if((isset($postVars["cntrltype"]))&&($postVars["cntrltype"]=="1")) echo "selected";
?>>Text Area</OPTION>
 </SELECT>
 </td></tr>
