...
?>
<h1><?php echo $loc->getText("Checkout Privileges");
?></h1>
<table class="primary">
                 <tr>
                     <th valign="top"><?php echo $loc->getText("function");
?></th>
<th valign="top">
...
foreach ($privs as $priv) {
    ...
    <td valign="top" align="center" class="<?php echo H($row_class);?>">
                                                  <a href="../admin/checkout_privs_edit_form.php?material_cd=<?php echo HURL($priv['material_cd']);?>&amp;classification=<?php echo HURL($priv['classification']);?>" class="<?php echo H($row_class);?>"><?php echo $loc->getText("edit");
    ?></a>
    </td>
