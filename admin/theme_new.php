...
?>
<?php echo $loc->getText("adminTheme_Theme");
?><?php echo H($theme->getThemeName());
?><?php echo $loc->getText("adminTheme_new_Added");
?><br><br>
<a href="../admin/theme_list.php"><?php echo $loc->getText("adminTheme_Return");
?></a>
