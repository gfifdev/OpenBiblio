...
<meta name="description" content="OpenBiblio Library Automation System">
                                 <title><?php echo H($_POST["themeName"]);
?> <?php echo $loc->getText("adminTheme_preview_Themepreview");
?></title>
...
<td class="title" valign="top" nowrap="yes"><font class="small"><a href="javascript:window.close()"><font color="<?php echo H(OBIB_TITLE_FONT_COLOR)?>"><?php echo $loc->getText("adminTheme_preview_CloseWindow");
?></font></a>&nbsp;
&nbsp;
</font></td>
</tr>
                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                 <td bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                                                                                                                                                                                                                                         <td bgcolor="<?php echo H(OBIB_TITLE_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                                                                                                                                                                                                                                                 <td width="2000" bgcolor="<?php echo H(OBIB_TITLE_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                         <tr bgcolor="<?php echo H(OBIB_TITLE_BG);?>">
                                                                                                                                                                                                                                                                 <td  bgcolor="<?php echo H(OBIB_ALT1_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                                                                                                                                                                                                                                                                             <td class="tab1" nowrap="yes"> <?php echo $loc->getText("adminTheme_preview_Home");
?> </td>
<td  bgcolor="<?php echo H(OBIB_ALT1_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
             <td bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                         <td  bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                                      <td class="tab2" nowrap="yes"> <a href="#" class="tab"><?php echo $loc->getText("adminTheme_preview_Circulation");
?></a> </td>
<td  bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
             <td bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                         <td  bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                                      <td class="tab2" nowrap="yes"> <a href="#" class="tab"><?php echo $loc->getText("adminTheme_preview_Cataloging");
?></a> </td>
<td  bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
             <td bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                         <td  bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                                      <td class="tab2" nowrap="yes"> <a href="#" class="tab"><?php echo $loc->getText("adminTheme_preview_Admin");
?></a> </td>
<td  bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
             <td bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
                         <td width="2000" bgcolor="<?php echo H(OBIB_TITLE_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
...
<?php echo $loc->getText("adminTheme_preview_Themepreview");
?><br>
<a href="#" class="alt1"><?php echo $loc->getText("adminTheme_preview_Samplelink");
?></a><br>
</font>
<br><br><br><br>
                                ...
                                <td height="100%" width="100%" valign="top">
                                        <font class="primary">
                                                    ...
                                                    **************************************************************************************-->
                                                        ...
                                                        <?php echo $loc->getText("adminTheme_preview_Thisstart");
?><?php echo H($_POST["themeName"]);
?> <?php echo $loc->getText("adminTheme_preview_Thisend");
?>

<h1><?php echo $loc->getText("adminTheme_preview_Samplelist");
?></h1>
<table class="primary">
                 <tr>
                 <th valign="top">
...
<br>
<a href="#"><?php echo $loc->getText("adminTheme_preview_Samplelink");
?></a><br>
<font class="error"><?php echo $loc->getText("adminTheme_preview_Sampleerror");
?></font><br />
<form>
                        ...
                        <input type="button" value="<?php echo $loc->getText("adminTheme_preview_Samplebutton"); ?>" class="button">
                                        ...
                                        **************************************************************************************-->
                                        ...
                                        <font face="Arial, Helvetica, sans-serif" size="1" color="<?php echo H(OBIB_PRIMARY_FONT_COLOR);?>">
                                                <center>
                                                <br><br>
                                                    <?php echo $loc->getText("adminTheme_preview_Poweredby");
?><br>
<?php echo $loc->getText("adminTheme_preview_Copyright");
?> <a href="http://dave.stevens.name">Dave Stevens</a><br>
           <?php echo $loc->getText("adminTheme_preview_underthe");
?>
<a href="../shared/copying.html"><?php echo $loc->getText("adminTheme_preview_GNU");
?></a>
</center>
<br>
</font>
